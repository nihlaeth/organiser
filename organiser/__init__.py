...
from organiser.views import index_handler
from organiser.views.calendar import calendar_handler
from organiser.views.lists import list_handler

class OrganiserConfiguration(Config):
...
def start():
    ...
    aiohttp_jinja2.setup(
        ...
        loader=jinja2.FileSystemLoader(resource_filename(
            Requirement.parse('organiser'), 'organiser/templates')),
